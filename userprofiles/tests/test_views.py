...
from userprofiles.models import \
    ...
    Project, \
    ProjectType
from wasteprocessors.models import \
    MaterialType, \
    WasteType, \
    Waste, \
    WasteProcessor
...
from userprofiles.models import UserType, Profile
import datetime
...
class LoginTestCase(TestCase):
    ...
    def test_new_user(self):
        ...
        'password1': 'letmein123!',
        'password2': 'letmein123!',
        }, follow=True)
        ...
        user = User.objects.get(email="test01@test.com")
